...
//  - a hypenated bullet pint. Again very long so that is has to wrap. Yes this
//    is vey long.
...
//      0 - now the single character followed by hyphen test indented at the
//          same level as last
 ...
 *   This should not be joined with the previous line and should wrap with the
 *   correct indentation. This should wrap happily with the previous line.
 *     A different indentation again.
 * And back a the first indentation.
 */

/// Doxygen style. with spaces.
///     1) test - hello there
